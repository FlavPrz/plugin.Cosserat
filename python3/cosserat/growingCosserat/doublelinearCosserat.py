...
cosserat_config1 = {'init_pos': [0., 0., 0.], 'tot_length': 6, 'nbSectionS': 6,
                   'nbFramesF': 12, 'buildCollisionModel': 1, 'beamMass': 0.22}


cosserat_config2 = {'init_pos': [0., -1., 0.], 'tot_length': 6, 'nbSectionS': 6,
                   'nbFramesF': 12, 'buildCollisionModel': 1, 'beamMass': 0.22}

cosserat_config3 = {'init_pos': [0., 0., 1.], 'tot_length': 6, 'nbSectionS': 6,
                   'nbFramesF': 12, 'buildCollisionModel': 1, 'beamMass': 0.22}

cosserat_config4 = {'init_pos': [0., 0., -1.], 'tot_length': 6, 'nbSectionS': 6,
                   'nbFramesF': 12, 'buildCollisionModel': 1, 'beamMass': 0.22}

cosserat_config5 = {'init_pos': [0., 0.75, -0.75], 'tot_length': 6, 'nbSectionS': 6,
                   'nbFramesF': 12, 'buildCollisionModel': 1, 'beamMass': 0.22}

cosserat_config6 = {'init_pos': [0., 0.75, 0.75], 'tot_length': 6, 'nbSectionS': 6,
                   'nbFramesF': 12, 'buildCollisionModel': 1, 'beamMass': 0.22}

cosserat_config7 = {'init_pos': [0., -0.75, 0.75], 'tot_length': 6, 'nbSectionS': 6,
                   'nbFramesF': 12, 'buildCollisionModel': 1, 'beamMass': 0.22}

cosserat_config8 = {'init_pos': [0., -0.75, -0.75], 'tot_length': 6, 'nbSectionS': 6,
                   'nbFramesF': 12, 'buildCollisionModel': 1, 'beamMass': 0.22}

cosserat_config9 = {'init_pos': [0., 1., 0.], 'tot_length': 6, 'nbSectionS': 6,
                   'nbFramesF': 12, 'buildCollisionModel': 1, 'beamMass': 0.22}
...
def createScene(rootNode):
    ...
    cosserat = solverNode.addChild(
        Cosserat(parent=solverNode, cosseratGeometry=cosserat_config1, name="cosserat1", radius=0.2))

    cosserat2 = solverNode.addChild(
        Cosserat(parent=solverNode, cosseratGeometry=cosserat_config2, name="cosserat2", radius=0.2))

    cosserat3 = solverNode.addChild(
        Cosserat(parent=solverNode, cosseratGeometry=cosserat_config3, name="cosserat3", radius=0.2))

    cosserat4 = solverNode.addChild(
        Cosserat(parent=solverNode, cosseratGeometry=cosserat_config4, name="cosserat4", radius=0.2))

    cosserat5 = solverNode.addChild(
        Cosserat(parent=solverNode, cosseratGeometry=cosserat_config5, name="cosserat5", radius=0.2))

    cosserat6 = solverNode.addChild(
        Cosserat(parent=solverNode, cosseratGeometry=cosserat_config6, name="cosserat6", radius=0.2))

    cosserat7 = solverNode.addChild(
        Cosserat(parent=solverNode, cosseratGeometry=cosserat_config7, name="cosserat7", radius=0.2))

    cosserat8 = solverNode.addChild(
        Cosserat(parent=solverNode, cosseratGeometry=cosserat_config8, name="cosserat8", radius=0.2))

    cosserat9 = solverNode.addChild(
        Cosserat(parent=solverNode, cosseratGeometry=cosserat_config9, name="cosserat9", radius=0.2))
